...
async def start(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text(f"👋 Welcome {username}!\nThis Tool is provided by @SharpX72. Select an option:", reply_markup=main_menu_keyboard())
...
async def genkey(update: Update, context: CallbackContext):
    ...
    if user_id in ADMIN_IDS:
        ...
        await context.bot.send_message(user_id, text="ONLY OWNER CAN USE💀OWNER @SharpX72")
